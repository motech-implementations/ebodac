...
public interface VisitDataService extends MotechDataService<Visit> {
    ...
    */
    ...
    @Lookup
    List<Visit> findVisitsByPlannedVisitDateLTAndActualVisitDate(@LookupField(name = "motechProjectedDate", customOperator = Constants.Operators.LT) LocalDate motechProjectedDate,
                                                     @LookupField(name = "date", customOperator = Constants.Operators.EQ) LocalDate date);
...
//    List<Visit> findVisitsBySubjectIdAndPlannedVisitDateAndActualVisitDate(@LookupField(name = "subject.id", customOperator = Constants.Operators.MATCHES_CASE_INSENSITIVE) String subjectId,
//                                                                                @LookupField(name = "motechProjectedDate", customOperator = Constants.Operators.LT) LocalDate motechProjectedDate,
//                                                                                @LookupField(name = "date", customOperator = Constants.Operators.EQ) LocalDate date);
//
//    @Lookup(name = "Find Visits By Participant Phone And Planned Visit Date And Actual Visit Date")
//    List<Visit> findVisitsBySubjectPhoneAndPlannedVisitDateAndActualVisitDate(@LookupField(name = "subject.phoneNumber", customOperator = Constants.Operators.MATCHES_CASE_INSENSITIVE) String phoneNumber,
//                                                                                @LookupField(name = "motechProjectedDate", customOperator = Constants.Operators.LT) LocalDate motechProjectedDate,
//                                                                                @LookupField(name = "date", customOperator = Constants.Operators.EQ) LocalDate date);
