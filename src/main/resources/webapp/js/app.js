(function () {
    ...
    reportBoosterVaccinationId, reportPrimerVaccinationId, ivrAndSmsStatisticReportId, callDetailRecordId, smsRecordId;
    ...
    ebodac.config(function ($routeProvider) {
        $routeProvider
            ...
            .when('/ebodac/ivrAndSmsStatisticReport', { redirectTo: '/mds/dataBrowser/' + ivrAndSmsStatisticReportId + '/ebodac' })
