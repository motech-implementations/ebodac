 ...
 * MotechDataService base class will provide the implementation of this class as
 * well as methods for adding, deleting, saving and finding all instances. In
 * this class we define and custom lookups we may need.
 */
public interface VisitDataService extends MotechDataService<Visit> {
    ...
    List<Visit> findBySubjectName(
            @LookupField(name = "subject.name", customOperator = Constants.Operators.MATCHES_CASE_INSENSITIVE) String name);

    @Lookup(name = "Find By Participant Community")
    List<Visit> findBySubjectCommunity(
            @LookupField(name = "subject.community", customOperator = Constants.Operators.MATCHES_CASE_INSENSITIVE) String community);

    @Lookup(name = "Find By Participant Address")
    List<Visit> findBySubjectAddress(
            @LookupField(name = "subject.address", customOperator = Constants.Operators.MATCHES_CASE_INSENSITIVE) String address);

    @Lookup(name = "Find By Participant Primer Vaccination Date")
    List<Visit> findBySubjectPrimerVaccinationDate(
            @LookupField(name = "subject.primerVaccinationDate") LocalDate primerVaccinationDate);

    @Lookup(name = "Find By Participant Primer Vaccination Date Range")
    List<Visit> findBySubjectPrimerVaccinationDateRange(
            @LookupField(name = "subject.primerVaccinationDate") Range<LocalDate> primerVaccinationDateRange);

    @Lookup(name = "Find By Participant Primer Vaccination Date Range And Site Name")
    List<Visit> findBySubjectPrimerVaccinationDateRangeAndSiteName(
            @LookupField(name = "subject.primerVaccinationDate") Range<LocalDate> primerVaccinationDateRange,
    ...
    List<Visit> findBySubjectBoosterVaccinationDate(
            @LookupField(name = "subject.boosterVaccinationDate") LocalDate boosterVaccinationDate);

    @Lookup(name = "Find By Participant Booster Vaccination Date Range")
    List<Visit> findBySubjectBoosterVaccinationDateRange(
            @LookupField(name = "subject.boosterVaccinationDate") Range<LocalDate> boosterVaccinationDateRange);

    @Lookup(name = "Find By Participant Booster Vaccination Date Range And Site Name")
    List<Visit> findBySubjectBoosterVaccinationDateRangeAndSiteName(
            @LookupField(name = "subject.boosterVaccinationDate") Range<LocalDate> boosterVaccinationDateRange,
            @LookupField(name = "subject.siteName", customOperator = Constants.Operators.MATCHES_CASE_INSENSITIVE) String siteName);
    ...
    @Lookup
    List<Visit> findByPlannedVisitDateRangeAndSiteName(
            @LookupField(name = "motechProjectedDate") Range<LocalDate> motechProjectedDateRange,
            @LookupField(name = "subject.siteName", customOperator = Constants.Operators.MATCHES_CASE_INSENSITIVE) String siteName);
    ...
    List<Visit> findBySubjectCommunityTypePhoneNumberAndAddress(
            @LookupField(name = "subject.community", customOperator = Constants.Operators.MATCHES_CASE_INSENSITIVE) String community,
            @LookupField(name = "type") Set<VisitType> visitType,
            @LookupField(name = "subject.phoneNumber", customOperator = Constants.Operators.EQ) String phoneNumber,
            @LookupField(name = "subject.address", customOperator = Constants.Operators.NEQ) String address);
    ...
    List<Visit> findBySubjectPrimerVaccinationDateTypePhoneNumberAndAddress(
            @LookupField(name = "subject.primerVaccinationDate") LocalDate primerVaccinationDate,
            @LookupField(name = "type") Set<VisitType> visitType,
            @LookupField(name = "subject.phoneNumber", customOperator = Constants.Operators.EQ) String phoneNumber,
            @LookupField(name = "subject.address", customOperator = Constants.Operators.NEQ) String address);
    ...
    List<Visit> findBySubjectPrimerVaccinationDateRangeTypePhoneNumberAndAddress(
            @LookupField(name = "subject.primerVaccinationDate") Range<LocalDate> primerVaccinationDateRange,
            @LookupField(name = "type") Set<VisitType> visitType,
            @LookupField(name = "subject.phoneNumber", customOperator = Constants.Operators.EQ) String phoneNumber,
            @LookupField(name = "subject.address", customOperator = Constants.Operators.NEQ) String address);
    ...
    List<Visit> findBySubjectBoosterVaccinationDateTypePhoneNumberAndAddress(
            @LookupField(name = "subject.boosterVaccinationDate") LocalDate boosterVaccinationDate,
            @LookupField(name = "type") Set<VisitType> visitType,
            @LookupField(name = "subject.phoneNumber", customOperator = Constants.Operators.EQ) String phoneNumber,
            @LookupField(name = "subject.address", customOperator = Constants.Operators.NEQ) String address);
    ...
    List<Visit> findBySubjectBoosterVaccinationDateRangeTypePhoneNumberAndAddress(
            @LookupField(name = "subject.boosterVaccinationDate") Range<LocalDate> boosterVaccinationDateRange,
            @LookupField(name = "type") Set<VisitType> visitType,
            @LookupField(name = "subject.phoneNumber", customOperator = Constants.Operators.EQ) String phoneNumber,
            @LookupField(name = "subject.address", customOperator = Constants.Operators.NEQ) String address);
    ...
    List<Visit> findBySubjectPrimerVaccinationDateRangeSiteNameTypePhoneNumberAndAddress(
            @LookupField(name = "subject.primerVaccinationDate") Range<LocalDate> primerVaccinationDateRange,
            @LookupField(name = "subject.siteName", customOperator = Constants.Operators.MATCHES_CASE_INSENSITIVE) String siteName,
            @LookupField(name = "type") Set<VisitType> visitType,
            @LookupField(name = "subject.phoneNumber", customOperator = Constants.Operators.EQ) String phoneNumber,
    ...
    List<Visit> findBySubjectBoosterVaccinationDateRangeSiteNameTypePhoneNumberAndAddress(
            @LookupField(name = "subject.boosterVaccinationDate") Range<LocalDate> boosterVaccinationDateRange,
            @LookupField(name = "subject.siteName", customOperator = Constants.Operators.MATCHES_CASE_INSENSITIVE) String siteName,
            @LookupField(name = "type") Set<VisitType> visitType,
            @LookupField(name = "subject.phoneNumber", customOperator = Constants.Operators.EQ) String phoneNumber,
    ...
    List<Visit> findBySubjectNameLess(
            @LookupField(name = "subject.phoneNumber", customOperator = Constants.Operators.EQ) String phoneNumber,
            @LookupField(name = "subject.name", customOperator = Constants.Operators.MATCHES_CASE_INSENSITIVE) String name,
            @LookupField(name = "motechProjectedDate", customOperator = Constants.Operators.LT) LocalDate motechProjectedDate,
            @LookupField(name = "date", customOperator = Constants.Operators.EQ) LocalDate date);
    ...
    List<Visit> findBySubjectCommunityLess(
            @LookupField(name = "subject.phoneNumber", customOperator = Constants.Operators.EQ) String phoneNumber,
            @LookupField(name = "subject.community", customOperator = Constants.Operators.MATCHES_CASE_INSENSITIVE) String community,
            @LookupField(name = "motechProjectedDate", customOperator = Constants.Operators.LT) LocalDate motechProjectedDate,
            @LookupField(name = "date", customOperator = Constants.Operators.EQ) LocalDate date);
    ...
    List<Visit> findBySubjectAddressLess(
            @LookupField(name = "subject.phoneNumber", customOperator = Constants.Operators.EQ) String phoneNumber,
            @LookupField(name = "subject.address", customOperator = Constants.Operators.MATCHES_CASE_INSENSITIVE) String address,
            @LookupField(name = "motechProjectedDate", customOperator = Constants.Operators.LT) LocalDate motechProjectedDate,
            @LookupField(name = "date", customOperator = Constants.Operators.EQ) LocalDate date);
    ...
    @Lookup
    List<Visit> findByPlannedVisitDateRangeAndSiteNameEq(
            @LookupField(name = "subject.phoneNumber", customOperator = Constants.Operators.EQ) String phoneNumber,
            @LookupField(name = "motechProjectedDate") Range<LocalDate> motechProjectedDateRange,
            @LookupField(name = "subject.siteName", customOperator = Constants.Operators.MATCHES_CASE_INSENSITIVE) String siteName,
            @LookupField(name = "date", customOperator = Constants.Operators.EQ) LocalDate date);
    ...
    List<Visit> findBySubjectNameAndPlannedVisitDateAndActualVisitDate(
            @LookupField(name = "subject.name", customOperator = Constants.Operators.MATCHES_CASE_INSENSITIVE) String name,
            @LookupField(name = "motechProjectedDate", customOperator = Constants.Operators.LT) LocalDate motechProjectedDate,
            @LookupField(name = "date", customOperator = Constants.Operators.EQ) LocalDate date);

    @Lookup(name = "Find By Participant Community And Planned Visit Date And Actual Visit Date")
    List<Visit> findBySubjectCommunityAndPlannedVisitDateAndActualVisitDate(
            @LookupField(name = "subject.community", customOperator = Constants.Operators.MATCHES_CASE_INSENSITIVE) String community,
            @LookupField(name = "motechProjectedDate", customOperator = Constants.Operators.LT) LocalDate motechProjectedDate,
            @LookupField(name = "date", customOperator = Constants.Operators.EQ) LocalDate date);

    @Lookup(name = "Find By Participant Address And Planned Visit Date And Actual Visit Date")
    List<Visit> findBySubjectAddressAndPlannedVisitDateAndActualVisitDate(
            @LookupField(name = "subject.address", customOperator = Constants.Operators.MATCHES_CASE_INSENSITIVE) String address,
            @LookupField(name = "motechProjectedDate", customOperator = Constants.Operators.LT) LocalDate motechProjectedDate,
            @LookupField(name = "date", customOperator = Constants.Operators.EQ) LocalDate date);
    ...
    @Lookup
    List<Visit> findByPlannedVisitDateRangeAndSiteNameAndActualVisitDate(
            @LookupField(name = "motechProjectedDate") Range<LocalDate> motechProjectedDateRange,
            @LookupField(name = "subject.siteName", customOperator = Constants.Operators.MATCHES_CASE_INSENSITIVE) String siteName,
            @LookupField(name = "date", customOperator = Constants.Operators.EQ) LocalDate date);
    ...
    List<Visit> findByActualDateRangeAndStageIdAndType(@LookupField(name = "date") Range<LocalDate> dateRange,
            @LookupField(name = "subject.stageId") Long stageId, @LookupField(name = "type") VisitType visitType);
