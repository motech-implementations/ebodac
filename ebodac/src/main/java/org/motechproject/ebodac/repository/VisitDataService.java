...
public interface VisitDataService extends MotechDataService<Visit> {
    ...
    */
    ...
    @Lookup(name = "Find By Type Date Primer Vaccination Date And Participant Name")
    List<Visit> findByTypeDatePrimerVaccinationDateAndSubjectName(@LookupField(name = "type") VisitType visitType,
    ...
    @Lookup(name = "Find By Participant Id Type Date Primer Vaccination Date And Participant Name")
    List<Visit> findBySubjectIdTypeDatePrimerVaccinationDateAndSubjectName(@LookupField(name = "subject.subjectId", customOperator = Constants.Operators.MATCHES_CASE_INSENSITIVE) String subjectId,
                                                                           @LookupField(name = "type") VisitType visitType,
                                                                           @LookupField(name = "date", customOperator = Constants.Operators.NEQ) LocalDate date,
                                                                           @LookupField(name = "subject.primerVaccinationDate", customOperator = Constants.Operators.EQ) LocalDate primerVaccinationDate,
                                                                           @LookupField(name = "subject.name", customOperator = Constants.Operators.MATCHES) String name);

    @Lookup(name = "Find By Participant Name Type Date And Primer Vaccination Date")
    List<Visit> findBySubjectNameTypeDateAndPrimerVaccinationDate(@LookupField(name = "subject.name",
            customOperator = Constants.Operators.MATCHES_CASE_INSENSITIVE) String name,
                                                                  @LookupField(name = "type") VisitType visitType,
